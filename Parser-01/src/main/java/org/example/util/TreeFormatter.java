...
/**
 * A set of utility routines useful for all kinds of ANTLR TreeFormatter.
 */
public class TreeFormatter {
   ...
   * parse TreeFormatter and extract data appropriately.
   */
  public static String toStringTree(Tree t) {
    return toStringTree(0, t, (List<String>) null);
  }
  ...
  public static String toStringTree(Tree t, Parser recog) {
    ...
    return toStringTree(0, t, ruleNamesList);
  }
   ...
   */
  public static String toStringTree(final int indent, final Tree t, final List<String> ruleNames) {
    ...
    for (int i = 0; i < t.getChildCount(); i++) {
      if (i > 0) buf.append(' ');
      buf.append(toStringTree(indent + 1, t.getChild(i), ruleNames));
    }
    buf.append(")");
    return buf.toString();
  }

  private static void padBuf(int indent, StringBuilder buf) {
    final int width = 3;
    buf.append("\n");
    buf.append(" ".repeat(width).repeat(Math.max(0, indent)));
  }
